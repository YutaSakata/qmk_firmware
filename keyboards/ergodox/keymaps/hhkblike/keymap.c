...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        KC_FN2,        KC_LGUI,     KC_ESC, KC_LALT,KC_LCTL,
                                                      RESET,  KC_LEFT,
                                                              KC_RIGHT,
                                        SFT_T(KC_SPC),KC_LGUI,LGUI(KC_SPC),
        // right hand
             KC_BSLS,     KC_6,   KC_7,   KC_8,   KC_9,   KC_0,             KC_MINS,
             TG(MDIA),    KC_Y,   KC_U,   KC_I,   KC_O,   KC_P,             KC_BSLS,
                          KC_H,   KC_J,   KC_K,   KC_L,   KC_SCLN,          KC_QUOT,
             TG(BASE),    KC_N,   KC_M,   KC_COMM,KC_DOT, KC_SLSH,          KC_ENT,
                          CTL_T(KC_LBRC), ALT_T(KC_RBRC), KC_ESC, KC_RGUI,  KC_FN1,
             KC_UP,  KC_ESC,
             KC_DOWN,
             LALT(LSFT(KC_P)),LALT(KC_LSFT), SFT_T(KC_ENT)
    ),
